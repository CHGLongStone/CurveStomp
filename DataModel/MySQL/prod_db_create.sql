create schema if not exists curvestomp collate utf8mb4_unicode_ci;
use curvestomp;

################################################################################################

# DESTROY DATABASE
drop table if exists curvestomp.report;
drop table if exists curvestomp.member;
drop table if exists curvestomp.household_location;
drop table if exists curvestomp.household;
drop table if exists curvestomp.location;
drop table if exists curvestomp.locale;
